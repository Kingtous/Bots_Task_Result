...
void knapsack_par(struct item * e, int c, int n, int v, int * sol, int l)
{
  ...
  if (omp_in_final() || ort_task_throttling())
    {
      ...
      /* byvalue variables */
      struct item * _fip_e = e, * e = _fip_e;
      int _fip_c = c, c = _fip_c;
      int _fip_n = n, n = _fip_n;
      int _fip_v = v, v = _fip_v;
      int _fip_l = l, l = _fip_l;
    ...
    /* (l226) #pragma omp task untied firstprivate(e, c, n, v, l) shared(without) */
    {
      struct __taskenv__ {
          int (* without);
          struct item * e;
  ...
  if (omp_in_final() || ort_task_throttling())
    ...
    /* (l230) #pragma omp task untied firstprivate(e, c, n, v, l) shared(with) */
    {
      struct __taskenv__ {
          int (* with);
          struct item * e;
