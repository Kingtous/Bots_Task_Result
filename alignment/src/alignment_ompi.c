                    ...
                    if (omp_in_final() || ort_task_throttling())
                      {
                        ...
                        int _fip_sj = sj, sj = _fip_sj;
                        int _fip_n = n, n = _fip_n;
                        int _fip_si = si, si = _fip_si;
                        int _fip_len1 = len1, len1 = _fip_len1;
                      ...
                      /* (l457) #pragma omp task untied private(i, gg, len2, mm_score) firstprivate(m, n, si, sj, len1) shared(nseqs, bench_output, seqlen_array, seq_array, gap_pos1, gap_pos2, pw_ge_penalty, pw_go_penalty, mat_avscore) */
                      {
                        struct __taskenv__ {
                            int m;
                            int sj;
